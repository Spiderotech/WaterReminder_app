              ...
              <View
                style={[
                  ...
                  selected
                    ...
                    : [styles.iconCircleUnselected, { backgroundColor: dark ? '#111' : '#fff', borderColor: dark ? '#555' : '#ccc' }],
                ]}
              >
                <FontAwesome5 name={g.icon} size={iconSize} color={selected ? '#fff' : dark ? '#ccc' : '#000'} />
              </View>
              <Text
                style={[
                  styles.genderLabel,
...
const styles = StyleSheet.create({
  ...
  iconCircle: { borderWidth: 2, justifyContent: 'center', alignItems: 'center' },
  iconCircleSelected: { backgroundColor: '#3498ff', borderColor: '#3498ff' },
  iconCircleUnselected: { backgroundColor: '#fff', borderColor: '#ccc' },
  genderLabel: { fontWeight: '500' },
  genderLabelSelected: { color: '#3498ff' },
});
